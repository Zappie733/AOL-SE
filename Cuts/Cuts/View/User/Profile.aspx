<%@ Page Title="User Profile" Language="C#" MasterPageFile="~/View/User/User.Master" AutoEventWireup="true" CodeBehind="Profile.aspx.cs" Inherits="Cuts.View.User.Profile" %>
         ...
         <table>
            ...
            <tr>
             ...
             <tr>
                ...
                <td>
                    <asp:TextBox ID="cityTextBox" runat="server" Enabled="false"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
